  ...
  return (
    <div className="min-h-screen  flex items-center justify-center mt-0  space-y-0 bg-logins bg-no-repeat w-full bg-center bg-cover px-6 ">
      <div className=" flex flex-col shadow-md md:mt-32 md:mb-16 p-8 bg-white w-full max-w-md rounded-md ">
        ...
        >
          {() => (
            <Form className="flex flex-col space-y-2 text-sm md:text-base w-full mt-6">
                    ...
                    {({
                      ...
                      <>
                        ...
                        <input
                          ...
                          } border rounded-md focus:outline-none focus:border-blue-600 border-slate-300 hover:border-slate-400`}
                        />
        ...
        {success && <AlertSignup signupResult={success} oppener={true} />}
